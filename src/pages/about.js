      ...
      <TransitionEffects />
        ...
        <main className='flex w-full flex-col items-center justify-center dark:text-light pt-2'>
            <Layout className='pt-16'>
                ...
                <AnimatedText title="Passion Fuels Purpose."  className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8"/>
                {/* Contenedor que albergara la biografia, foto y la experiencia  */}
                <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                    {/* biografia  */}
                    <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                        <h2 className='dark:text-light/75 mb-4 text-lg font-bold uppercase text-dark/75'>Biography</h2>
                    ...
                    dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8'>
                        ...
                        <Image src={profileImage} alt="JavierMills" className='w-full h-auto rounded-2xl' 
